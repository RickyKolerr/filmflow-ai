      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <Card 
              key={index} 
              className="relative overflow-hidden p-6 bg-black/50 border-primary/10 backdrop-blur-sm hover:bg-black/70 transition-all duration-300 hover:scale-105 hover:border-accent/50 group animate-fade-up"

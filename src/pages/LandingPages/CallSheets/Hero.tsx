      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-12 text-gray-300 animate-fade-up max-w-2xl mx-auto">
            Create professional call sheets in seconds with AI-powered precision. Streamline your production workflow.
          </p>
          <div className="flex flex-col md:flex-row gap-6 justify-center animate-fade-up">
            ...
            >
              ...
              <Film className="ml-2 w-5 h-5 group-hover:rotate-12 transition-transform" />
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
